...
static int parseCmdArgs(int argc, char** argv)
{
	...
	/*
	else if (string(argv[i]) == "--image_directory")
	{
	    img_dir = argv[i + 1];	
	}
	*/
...
int main(int argc, char* argv[])
{
	...
	auto startF = std::chrono::high_resolution_clock::now();
        ...
        std::chrono::duration<double> diffF = endF - startF;
        std::cout << "Finding features of each image, time: " << diffF.count() << " s\n";
    }
    ...
    diff = end - start;
    std::cout << "Finding features overall, time: " << diff.count() << " s\n";
    ...
    diff = end - start;
    std::cout << "Pairwise matching overall, time: " << diff.count() << " s\n";
    ...
    diff = end - start;
    std::cout << "Warping images overall, time: " << diff.count() << " s\n";
	...
	auto startC = std::chrono::high_resolution_clock::now();
    	...
    	std::cout << "Compositing each image, time: " << diffC.count() << " s\n";
    }
    ...
    if (!timelapse)
    {
        ...
        diff = end - start;
    	std::cout << "Compositing overall, time: " << diff.count() << " s\n";
